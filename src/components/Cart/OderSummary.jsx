    ...
    return (
        <section className="mx-2">
            ...
            <div className="my-10 flex flex-col  rounded-md border-solid border-[#EBEBEB] border-2 ">
                <h2 className="text-2xl font-semibold capitalize mt-14 mb-10 ml-2">order summary</h2>
                ...
                <button type="button" className="bg-black text-white capitalize  rounded-md cursor-pointer py-4  w-[95%]">checkout</button>
                </div>
            </div>
